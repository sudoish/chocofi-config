...
0=BASE, 1=BASE_WIN, 2=NUM, 3=NAV, 4=NAVW, 5=SYM_L, 6=SYM_R, 7=SYM_RW, 8=ADJ, 9=LOCK

BASE and BASE_WIN are OS-specific base layers (macOS/Windows). NAV/NAVW are similarly duplicated. SYM is split into SYM_L (left-hand symbols) and SYM_R (right-hand symbols) for two-handed access; SYM_RW is the Windows variant of SYM_R. Conditional layers activate NAVW when BASE_WIN is active, SYM_RW when BASE_WIN+SYM_R, and ADJ is a tri-layer (SYM_L+SYM_R).
